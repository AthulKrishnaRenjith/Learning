...
to create-next-generation
  ...
  repeat crossover-count [
    ...
    print word parent2 ([bits] of parent2)
...
to-report crossover [bits1 bits2]
  ...
  report list (sentence (sublist bits1 0 split-point)(sublist bits2 split-point length bits2))(sentence (sublist bits2 0 split-point)(sublist bits1 split-point length bits1))
...
"" ""
PENS
"default" 1.0 0 -2674135 true "" "plot max [fitness] of turtles"
